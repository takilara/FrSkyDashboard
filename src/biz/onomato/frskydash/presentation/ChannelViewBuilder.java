...
public class ChannelViewBuilder {
	 ...
	 * tag for logging
	 */
	private static final String TAG = "ChannelViewBuilder";
	
	private static ChannelViewBuilder instance = null;
	
	private ChannelViewBuilder(){}
	
	public static ChannelViewBuilder getInstance(){
		if (instance == null)
			instance = new ChannelViewBuilder();
		return instance;
	}
